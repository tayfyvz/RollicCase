...
namespace TadPoleFramework
{
    public class PlatformController : Platform
    {
        ...
        {
            base.Awake();
            platformMat = transform.GetChild(1).GetComponent<Renderer>().material;
    ...
    public void SpawnBalls(int amount)
    {
        ...
        if (amount == ballsParent.childCount && ballsParent.childCount > 0 && ballsParent.GetChild(0).position !=
            new Vector3(0, ballsParent.position.y, myRoadTransform.position.z))
        {
